...
#             # Llamar al servicio de extracción en un hilo separado
#             extraction_result = await asyncio.to_thread(
#                 PDFExtractionService.extract_pdf_content, temp_file_path
#             )

#             # Combinar resultado del servicio con información del archivo
#             result = {
#                 "filename": file.filename,
#                 "size_bytes": file_size,
#                 **extraction_result
